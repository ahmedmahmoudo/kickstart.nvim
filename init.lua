...
-- Disable default vim opening screen (Directory listing)
...
require('lazy').setup({
      ...
      statusline.setup {
        ...
        content = {
          active = function()
            ...
            return statusline.combine_groups { { hl = 'MiniStatuslineFilename', strings = { filename, location } } }
          end,
        },
      }
  ...
  },
  {
    ...
    config = function()
      ...
      treesitter_context.setup { max_lines = 1 }
